...
const LaptopBase = (props) => {
    ...
    const { pages: { revenue: { rwd: { laptop } } } } = Theme;
    ...
    return (
        <>
            ...
            >
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptop.barChartContainer}
                >
                    <RevenueBarChart />
                </BasicContainer>
