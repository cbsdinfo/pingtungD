...
const LaptopBase = (props) => {
    ...
    const { pages: { exportReport: { rwd: { laptop } } } } = Theme;
            ...
            >
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"匯出報表"}
                        theme={laptop.exportSubTitleBar}
                    />

                    {/* 匯出報表 區域容器 */}
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptop.exportListContainer}
                    >

                        {/* 匯出報表表單區域容器 */}
                        <FormContainer
                            bascDefaultTheme={"DefaultTheme"}
                            theme={laptop.exportFromContainer}
                        >
                            <FormRow>
                            ...
                            >
                                ...
                                <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                    ...
                                    <NativeLineButton
                                        ...
                                        disable={false}
                                        type="button" // 防止提交
                                        theme={laptop.reimbursementButton}
                                        onClick={(e) => {
                                            e.preventDefault();
