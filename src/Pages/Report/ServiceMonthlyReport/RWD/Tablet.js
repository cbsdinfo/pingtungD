...
const TabletBase = (props) => {
    ...
    const { pages: { serviceMonthlyReport: { rwd: { tablet } } } } = Theme;
    ...
    return (
        <>
                    ...
                    <>
                        ...
                        >
                            ...
                            <Selector
                                ...
                                value={globalContextService.get("ServiceMonthlyReportPage", "UserIdentity") ?? [{ value: '0', label: '請選擇用戶身分' }]}
            ...
            >
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={tablet.orderRecordContainer}
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"區域已完成趟次比例"}
                        theme={tablet.orderRecordSubTitleBar}
                    >
                    ...
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={tablet.orderRecordTableContainer}
                    >
                    ...
                    <OldTable
                        ...
                        checkboxOnChecked={
                            (checkedRowKeys, checkedRows) => {
                                ...
                                globalContextService.set("ServiceMonthlyReportPage", "CheckedRowKeys", checkedRowKeys);
                                globalContextService.set("ServiceMonthlyReportPage", "CheckedRowsData", checkedRows);
                            }
                        }
                        ...
                        //showHeader={false}
                        data={([
                            { id: 0, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 1, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 2, areaName: "新莊區", totalTimes: "11151次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 3, areaName: "新莊區", totalTimes: "9111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 4, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 5, areaName: "新莊區", totalTimes: "14511次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 6, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 7, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 8, areaName: "新莊區", totalTimes: "114次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 9, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 10, areaName: "新莊區", totalTimes: "11711次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 11, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 12, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 13, areaName: "新莊區", totalTimes: "1171次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 14, areaName: "新莊區", totalTimes: "11181次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 15, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 16, areaName: "新莊區", totalTimes: "1991次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 17, areaName: "新莊區", totalTimes: "1111次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 18, areaName: "新莊區", totalTimes: "1171次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 19, areaName: "新莊區", totalTimes: "111651次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 20, areaName: "新莊區", totalTimes: "11121次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                            { id: 21, areaName: "新莊區", totalTimes: "11411次", finishTimes: 5000, emptyTimes: 10000, noDo: "50" },
                        ])}
                        // data={[{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},]}
