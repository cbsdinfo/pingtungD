...
const LaptopBase = (props) => {
    ...
    const { pages: { pickUpData: { rwd: { laptop } } } } = Theme;
        ...
        <>
                                                ...
                                                >
                                                    <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                        ...
                                                        <TextInput
                                                            ...
                                                            theme={laptop.exportDateBetween}
                                                        />
                                                        ...
                                                        <Selector
                                                            ...
                                                            menuPosition={true}
                                                            theme={laptop.exportCarDealership}
                                                        ...
                                                        <Selector
                                                            ...
                                                            menuPosition={true}
                                                            theme={laptop.exportBoonType}

                                                        />
                                                    </FormRow>
                                                </FormContainer>
                                            ),
                                            theme: laptop.exportModal
                                        })
                                        //#endregion
                                    }}
                                >
            ...
            >
                ...
                {globalContextService.get("PickUpDataPage", "UserCaseType")?.label !== "長照個案" &&
                    <Container
                        baseDefaultTheme={"DefaultTheme"}
                        theme={laptop.totalInfoCardOutContainer}
                    >
                        {/* 總趟次資訊卡片 容器 */}
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                ...
                {globalContextService.get("PickUpDataPage", "UserCaseType")?.label === "長照個案" &&
                    <Container
                        baseDefaultTheme={"DefaultTheme"}
                        theme={laptop.caseTotalInfoCardOutContainer}
                    >
                        {/* 總趟次資訊卡片 容器 */}
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                            theme={laptop.caseTotalInfoCardContainer}
                        >
                            {/* 總趟次資訊卡片 */}
                            <InfoCard
                                centerText={"總趟次"}
                                bottomText={"0"}
                                icon={<BarChartLine style={laptop.caseTotalInfoCardIcon} />}
                                theme={laptop.caseTotalInfoCard}
                            />
                        </SubContainer>
                        ...
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                            theme={laptop.caseDoneInfoCardContainer}
                        >
                            {/* 已完成資訊卡片 (共乘) */}
                            <InfoCard
                                centerText={"已完成(共乘)"}
                                bottomText={"0"}
                                icon={<CheckCircle style={laptop.caseDoneInfoCardIcon} />}
                                theme={laptop.caseDoneInfoCard}
                            />
                        </SubContainer>
                        ...
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                            theme={laptop.caseEmptyInfoCardContainer}
                        >
                            {/* 空趟資訊卡片 */}
                            <InfoCard
                                centerText={"空趟"}
                                bottomText={"0"}
                                icon={<Loading3Quarters style={laptop.caseEmptyInfoCardIcon} />}
                                theme={laptop.caseEmptyInfoCard}
                            />
                        </SubContainer>
                        ...
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                            theme={laptop.caseNoDoInfoCardContainer}
                        >
                            {/* 未執行資訊卡片 */}
                            <InfoCard
                                centerText={"未執行"}
                                bottomText={"0"}
                                icon={<InfoCircle style={laptop.caseNoDoInfoCardIcon} />}
                                theme={laptop.caseNoDoInfoCard}
                            />
                        </SubContainer>
                        ...
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                            theme={laptop.caseRateInfoCardContainer}
                        >
                            {/* 達成率資訊卡片 */}
                            <InfoCard
                                centerText={"達成率"}
                                bottomText={"0%"}
                                icon={<Star style={laptop.caseRateInfoCardIcon} />}
                                theme={laptop.caseRateInfoCard}
                            />
                        </SubContainer>
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptop.pickUpDataContainer}
                >

                    {/* 接送數據Chart區域容器 */}
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptop.pickUpDataChartContainer}
                    >
