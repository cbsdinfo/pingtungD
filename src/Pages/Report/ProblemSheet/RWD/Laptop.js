...
const LaptopBase = (props) => {
    ...
    const { pages: { problemSheet: { rwd: { laptop } } } } = Theme;
                        ...
                        >
                            ...
                            <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                ...
                                <NativeLineButton
                                    ...
                                    disable={false}
                                    type="button" // 防止提交
                                    theme={laptop.carDealerRecordStatusButton}
                                    onClick={(e) => {
                                        e.preventDefault();
                                        ...
                                        modalsService.titleModal.normal({
                                            ...
                                            content: (
                                                <>
                                                    ...
                                                    <ScrollBar
                                                        basedefaulttheme={"DefaultTheme"}
                                                        theme={laptop.statusInModalContentScrollBar}
                                                    >
                                                        {/* 各車行記點狀況彈窗 ScrollBar 下容器 */}
                                                        <BasicContainer
                                                            bascDefaultTheme={"DefaultTheme"}
                                                            theme={laptop.statusInModalMainContent}
                                                        >
                                                            {/* 各車行記點狀況 List */}
                                                            <OldList
                                                                checkbox={false}
                                        ...
                                        return (
                                            <>
                                                ...
                                                <NativeLineButton
                                                    ...
                                                    disable={false}
                                                    type="button" // 防止提交
                                                    theme={laptop.checkNotPassButton}
                                                // onClick={() => { ) }}
                                                >審核不通過
                                            </NativeLineButton>
                                            </>
