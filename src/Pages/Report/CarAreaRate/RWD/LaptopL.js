...
const LaptopLBase = (props) => {
    ...
    const { pages: { carAreaRate: { rwd: { laptopL } } } } = Theme;
    ...
    return (
        <>
                    ...
                    <>
                        ...
                        >
                            ...
                            <Selector
                                ...
                                value={globalContextService.get("CarAreaRatePage", "UserIdentity") ?? ""}
            ...
            >
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptopL.returnRateContainer}
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"返回區域比例"}
                        theme={laptopL.returnRateSubTitleBar}
                    >
                    ...
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptopL.returnRateTableContainer}
                    >
