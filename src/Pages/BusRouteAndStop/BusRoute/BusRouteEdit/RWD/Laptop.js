...
const LaptopBase = (props) => {
    ...
    const { pages: { busRoute: { busRouteEdit: { rwd: { laptop } } } } } = Theme;
            ...
            >
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"路線設定"}
                        theme={laptop.setRouteSubTitleBar}
                    >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"站牌設定"}
                        theme={laptop.setStationSubTitleBar}
                    />

                    {/* 站牌設定表單區域容器 */}
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptop.transferContainer}
                    >
                        {/* 站牌設定穿梭框 */}
                        <Transfer
                            data={props?.AllStops}
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"站牌排序設定"}
                        theme={laptop.setStationSortSubTitleBar}
                    />

                    {/* 站牌排序設定區域容器 */}
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptop.setStationSortContainer}
                    >
                        <StopDragSort
                            stops={
