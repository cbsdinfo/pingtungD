...
export const AddCaseFastCallCar = (props) => {
    ...
    const controllGCS = (type, payload) => {
        switch (type) {
            case "return":
                ...
                globalContextService.remove("AddCaseFastCallCarPage");
                //#endregion
                break;
    ...
    useEffect(() => {
        const historyUnlisten = history.listen((location, action) => {
            ...
            globalContextService.remove("AddCaseFastCallCarPage", "firstUseAPIgetClient");
            globalContextService.remove("AddCaseFastCallCarPage", "firstUseAPIgetCaseUsers");
        });
