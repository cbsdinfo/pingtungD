...
const LaptopLBase = (props) => {
    ...
    const { pages: { userManager: { rwd: { laptopL } } } } = Theme;
        ...
        <>
                                                    ...
                                                    content: (
                                                        ...
                                                        >
                                                            <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                                ...
                                                                <TreeSelector
                                                                    bascDefaultTheme={"DefaultTheme"}
                                                                    topLabel={<>服務單位<Text theme={laptopL.organizationsRequired}>(必填)</Text></>}
                                                                    //viewType
                                                                    isSearchable
                                                                    placeholder={""}
                                                                    isMulti
                                                                    ...
                                                                    menuPosition={true}
                                                                    theme={laptopL.organizations}
                                                                />

                                                                {/* 新增彈窗 - 帳號 Account */}
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>帳號<Text theme={laptopL.accountRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                    ...
                                                                    theme={laptopL.account}
                                                                />

                                                                {/* 新增彈窗 - 手機號碼 Cellphone */}
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>手機號碼<Text theme={laptopL.cellphoneRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                    ...
                    >
                        ...
                        >
                            ...
                            <Text
                                ...
                                onClick={() => {
                                    if (globalContextService.get("UserManagerPage", "orgId") !== "") {
                                        props.GetSubUsersExecute(true, "");
                                        globalContextService.set("UserManagerPage", "orgId", "");
                                        globalContextService.get("UserManagerPage", "setSelectStateForTreeSelector")("");
                                    }
                                                    ...
                                                    <>
                                                        {rowData.status === 1 ?
                                                            <Tag
                                                                ...
                                                                theme={laptopL.disableTag}
                                                                text={"停用"}
                                                            />
                                                            :
                                                            <Tag
                                                                baseDefaultTheme={"SuccessTheme"}
                                                                theme={laptopL.enableTag}
                                                                text={"正常"}
                                                            />
                                                        }
            ...
            {props.OpenAssign &&
                <AssignRoleToUserTitleModal
                    ...
                    AssignRoleUsersPending={props.AssignRoleUsersPending}
                />
            }
        </>
    )
