...
const LaptopBase = (props) => {
    ...
    const { pages: { userManager: { rwd: { laptop } } } } = Theme;
                                                    ...
                                                    content: (
                                                        ...
                                                        >
                                                            <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                                ...
                                                                <TreeSelector
                                                                    bascDefaultTheme={"DefaultTheme"}
                                                                    topLabel={<>服務單位<Text theme={laptop.organizationsRequired}>(必填)</Text></>}
                                                                    //viewType
                                                                    isSearchable
                                                                    placeholder={""}
                                                                    isMulti
                                                                    ...
                                                                    menuPosition={true}
                                                                    theme={laptop.organizations}
                                                                />

                                                                {/* 新增彈窗 - 帳號 Account */}
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>帳號<Text theme={laptop.accountRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                    ...
                                                                    theme={laptop.account}
                                                                />

                                                                {/* 新增彈窗 - 手機號碼 Cellphone */}
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>手機號碼<Text theme={laptop.cellphoneRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                    ...
                                                    <>
                                                        {rowData.status === 1 ?
                                                            <Tag
                                                                ...
                                                                theme={laptop.disableTag}
                                                                text={"停用"}
                                                            />
                                                            :
                                                            <Tag
                                                                baseDefaultTheme={"SuccessTheme"}
                                                                theme={laptop.enableTag}
                                                                text={"正常"}
                                                            />
                                                        }
