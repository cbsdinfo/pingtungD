...
const TabletBase = (props) => {
    ...
    const { pages: { operatingUnitSetting: { rwd: { tablet } } } } = Theme;
                                            ...
                                            content: (
                                                ...
                                                >
                                                    <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>車行名稱<Text theme={tablet.carDealerShipNameRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                            ...
                                                            theme={tablet.carDealerShipName}
                                                        />

                                                        {/* 新增彈窗 - 接收訂單通知Email Email */}
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>接收訂單通知Email<Text theme={tablet.emailRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>主要聯絡人姓名<Text theme={tablet.mainContactNameRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                            ...
                                                            theme={tablet.mainContactName}
                                                        />

                                                        {/* 新增彈窗 - 聯絡市話 Phone */}
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>聯絡市話<Text theme={tablet.phoneRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
