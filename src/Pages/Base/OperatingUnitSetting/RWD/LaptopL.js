...
import { ReactComponent as Plus } from '../../../../Assets/img/OperatingUnitSetting/Plus.svg'
...
const LaptopLBase = (props) => {
    ...
    const { pages: { operatingUnitSetting: { rwd: { laptopL } } } } = Theme;
                                            ...
                                            content: (
                                                ...
                                                >
                                                    <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>車行名稱<Text theme={laptopL.carDealerShipNameRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                            ...
                                                            theme={laptopL.carDealerShipName}
                                                        />

                                                        {/* 新增彈窗 - 接收訂單通知Email Email */}
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>接收訂單通知Email<Text theme={laptopL.emailRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>主要聯絡人姓名<Text theme={laptopL.mainContactNameRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                            ...
                                                            theme={laptopL.mainContactName}
                                                        />

                                                        {/* 新增彈窗 - 聯絡市話 Phone */}
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>聯絡市話<Text theme={laptopL.phoneRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                        ...
                                                        <Selector
                                                            bascDefaultTheme={"DefaultTheme"}
                                                            topLabel={<>地址<Text theme={laptopL.addCountiesRequired}>(必填)</Text></>}
                                                            //viewType
                                                            isSearchable
                                                            placeholder={"請選擇縣市"}
                                                            // isMulti
                                                            ...
                                                            menuPosition={true}
                                                            theme={laptopL.addCounties}
                                                        />
                                                        {/* 新增彈窗 - 區域 District */}
                                                        <Selector
                                                            bascDefaultTheme={"DefaultTheme"}
                                                            // topLabel={<>區域<Text theme={laptopL.addDistrictRequired}>(必填)</Text></>}
                                                            //viewType
                                                            isSearchable
                                                            placeholder={"請選擇區域"}
                                                            // isMulti
