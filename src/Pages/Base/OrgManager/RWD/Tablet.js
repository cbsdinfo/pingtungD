                                                    ...
                                                    content: (
                                                        ...
                                                        >
                                                            <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                                ...
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>單位名稱<Text theme={tablet.unitNameRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                ...
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>統一編號<Text theme={tablet.uidRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                ...
                                                                <TextInput
                                                                    topLabel={<>主要聯絡人<Text theme={tablet.firstContactRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                ...
                                                                <TextInput
                                                                    topLabel={<>主要聯絡人市話<Text theme={tablet.firstContactTelephoneRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                ...
                                                                <TreeSelector
                                                                    bascDefaultTheme={"DefaultTheme"}
                                                                    topLabel={<>上層機構<Text theme={tablet.upperOrgRequired}>(必填)</Text></>}
                                                                    //viewType
                                                                    isSearchable
                                                                    placeholder={"請選擇個案身分"}
                                                                    // isMulti
                                ...
                                <TreeSelector
                                    ...
                                    onChange={(e, value, onInitial) => {
                                        if (globalContextService.get("OrgManagerPage", "orgId") !== value.value) {
                                            globalContextService.set("OrgManagerPage", "orgId", value.value) // 提前更新orgId的值，而不等到API査完才更新
