...
const LaptopLBase = (props) => {
    ...
    const { pages: { orgManager: { rwd: { laptopL } } } } = Theme;
    ...
    return (
        <>
                                                    ...
                                                    content: (
                                                        ...
                                                        >
                                                            <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                                ...
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>單位名稱<Text theme={laptopL.unitNameRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                    ...
                                                                    theme={laptopL.unitName}
                                                                />
                                                                {/* 新增彈窗 - 統一編號 Uid */}
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>統一編號<Text theme={laptopL.uidRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                ...
                                                                <TextInput
                                                                    topLabel={<>主要聯絡人<Text theme={laptopL.firstContactRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                    ...
                                                                    theme={laptopL.firstContact}
                                                                />
                                                                {/* 新增彈窗 - 主要聯絡人市話 FirstContactTelephone */}
                                                                <TextInput
                                                                    topLabel={<>主要聯絡人市話<Text theme={laptopL.firstContactTelephoneRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                                                    ...
                                                                    theme={laptopL.firstContactTelephone}
                                                                />
                                                                ...
                                                                <TextInput
                                                                    ...
                                                                    theme={laptopL.firstContacCellhone}
                                                                />
                                                                {/* 新增彈窗 - 狀態 Status */}
                                                                <Selector
                                                                    bascDefaultTheme={"DefaultTheme"}
                                                                ...
                                                                <TreeSelector
                                                                    bascDefaultTheme={"DefaultTheme"}
                                                                    topLabel={<>上層機構<Text theme={laptopL.upperOrgRequired}>(必填)</Text></>}
                                                                    //viewType
                                                                    isSearchable
                                                                    placeholder={"請選擇個案身分"}
                                                                    // isMulti
                            ...
                            {/* 分配用戶按鈕容器 */}
                            {
                                ...
                                (
                                    <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                        ...
                                        >
                                            {/* 分配用戶按鈕 圖標 */}
                                            <Assign style={laptopL.assignButtonIcon} />
                                            分配用戶
                                        </NativeLineButton>
                                    </SubContainer>
                                )
                                                ...
                                                //#region 選一個
                                                    ...
                                                    modalsService.titleModal.normal({
                                                        ...
                                                        yesOnClick: (e, close) => {
                                                            //#region 表單驗證
                                                            let validMsg = "";
                                                            if (valid(globalContextService.get("OrgManagerPage", "FirstContact") ?? "", ["^.{1,}$"], ["請輸入主要聯絡人"])[1]) {
                                                                validMsg = valid(globalContextService.get("OrgManagerPage", "FirstContact") ?? "", ["^.{1,}$"], ["請輸入主要聯絡人"])[1]
                                                            }
                                                            else if (valid(globalContextService.get("OrgManagerPage", "FirstContactTelephone") ?? "", ["^.{1,}$"], ["請輸入主要聯絡人市話"])[1]) {
                                                                validMsg = valid(globalContextService.get("OrgManagerPage", "FirstContactTelephone") ?? "", ["^.{1,}$"], ["請輸入主要聯絡人市話"])[1]
                            ...
                            {/* 刷新按鈕容器 */}
                            {
                                ...
                                (
                                    <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                        ...
                                        >
                                            {/* 刷新按鈕 圖標 */}
                                            <Refresh style={laptopL.refreshButtonIcon} />
                                刷新
                                </NativeLineButton>
                                    </SubContainer>
                                )
            ...
            >
                ...
                <Container
                    bascDefaultTheme={"DefaultTheme"}
                    theme={laptopL.leftMenuRightTableContainer}
                >
                    {/* 左側選單容器 */}
                    <SubContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptopL.leftMenuContainer}
                    >
                        <BasicContainer
                            bascDefaultTheme={"DefaultTheme"}
                            theme={laptopL.leftMenuSubContainer}
                        >
                            {/* 查詢所有機構 */}
                            <Text
                                bascDefaultTheme={"DefaultTheme"}
                                theme={laptopL.getSubOrgsExecute}
                                onClick={() => {
                            ...
                            {/* 左側選單容器 ScrollBar */}
                            <ScrollBar
                                theme={laptopL.leftMenuSubScrollBar}
                            >
                                {/* 在此遍歷選單(機構)內容 */}
                                <OrgsTree
                                    // theme={{}}
                    ...
                    <SubContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptopL.rightTableContainer}
                    >
                        <BasicContainer
                            bascDefaultTheme={"DefaultTheme"}
                            theme={laptopL.rightTableSubContainer}
                        >
                            <OldTable
