...
const LaptopBase = (props) => {
    ...
    const { pages: { roleManager: { rwd: { laptop } } } } = Theme;
                                                    ...
                                                    content: (
                                                        ...
                                                        >
                                                            <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                                ...
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>角色名稱<Text theme={laptop.roleNameRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                    ...
                                    <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                        <DropDown
                                            dropDownItem={
                                                <>
                                                    ...
                                                    <BasicContainer
                                                        baseDefaultTheme={"DefaultTheme"}
                                                        theme={laptop.dropDownItemContainer}>
                                                        {/* DropDown 子項目 */}
                                                        <Text
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            theme={laptop.dropDownSubItemContainer}
                                                            onClick={() => {
                                                                // let checkedRowKeys = globalContextService.get("RoleManagerPage", "CheckedRowKeys");
                                                                let checkedRowsData = globalContextService.get("RoleManagerPage", "CheckedRowsData");
                                                        ...
                                                        >
                                                            <Group style={laptop.dropDownSubItemIcon} />
                                                            為用戶添加角色
                                                        </Text>
                                                        ...
                                                        >
                                                            <RoleMoudle style={laptop.dropDownSubItemIcon} />
                                                            為角色分配模塊
                                                        </Text>
                                                    </BasicContainer>
                                                </>
                                        ...
                                        >
                                            ...
                                            >
                                                角色分配
                                                {/* 角色分配按鈕 圖標 */}
                                                <Down style={laptop.assignButtonIcon} />
                                            </NativeLineButton>
                                        </DropDown>
                                    </SubContainer>
                                )
                                            ...
                                            <>
                                                {rowData.status === 1 ?
                                                    <Tag
                                                        ...
                                                        theme={laptop.tableDisableTag}
                                                        text={"停用"}
                                                    />
                                                    :
                                                    <Tag
                                                        baseDefaultTheme={"SuccessTheme"}
                                                        theme={laptop.tableEnableTag}
                                                        text={"正常"}
                                                    />
                                                }
