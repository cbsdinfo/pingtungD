...
const TabletBase = (props) => {
    ...
    const { pages: { roleManager: { rwd: { tablet } } } } = Theme;
                                                    ...
                                                    content: (
                                                        ...
                                                        >
                                                            <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                                ...
                                                                <TextInput
                                                                    // viewType
                                                                    topLabel={<>角色名稱<Text theme={tablet.roleNameRequired}>(必填)</Text></>}
                                                                    baseDefaultTheme={"DefaultTheme"}
                                                                    type="text"
                                                                    placeholder={""}
                                    ...
                                    <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                        <DropDown
                                            dropDownItem={
                                                <>
                                                    ...
                                                    <BasicContainer
                                                        baseDefaultTheme={"DefaultTheme"}
                                                        theme={tablet.dropDownItemContainer}>
                                                        {/* DropDown 子項目 */}
                                                        <Text
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            theme={tablet.dropDownSubItemContainer}
                                                            onClick={() => {
                                                                // let checkedRowKeys = globalContextService.get("RoleManagerPage", "CheckedRowKeys");
                                                                let checkedRowsData = globalContextService.get("RoleManagerPage", "CheckedRowsData");
                                                        ...
                                                        >
                                                            <Group style={tablet.dropDownSubItemIcon} />
                                                            為用戶添加角色
                                                        </Text>
                                                        ...
                                                        >
                                                            <RoleMoudle style={tablet.dropDownSubItemIcon} />
                                                            為角色分配模塊
                                                        </Text>
                                                    </BasicContainer>
                                                </>
                                        ...
                                        >
                                            ...
                                            >
                                                角色分配
                                                {/* 角色分配按鈕 圖標 */}
                                                <Down style={tablet.assignButtonIcon} />
                                            </NativeLineButton>
                                        </DropDown>
                                    </SubContainer>
                                )
                                            ...
                                            <>
                                                {rowData.status === 1 ?
                                                    <Tag
                                                        ...
                                                        theme={tablet.tableDisableTag}
                                                        text={"停用"}
                                                    />
                                                    :
                                                    <Tag
                                                        baseDefaultTheme={"SuccessTheme"}
                                                        theme={tablet.tableEnableTag}
                                                        text={"正常"}
                                                    />
                                                }
