...
const LaptopBase = (props) => {
    ...
    const { pages: { carFixedRecord: { rwd: { laptop } } } } = Theme;
                                            ...
                                            content: (
                                                ...
                                                >
                                                    <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>車輛<Text theme={laptop.modalCarRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                            ...
                                                            theme={laptop.modalCar}
                                                        />

                                                        {/* 新增彈窗 - 日期 AddDate */}
                                                        <DateTimePicker
                                                            topLabel={<>日期<Text theme={laptop.modalDateRequired}>(必填)</Text></>}
                                                        ...
                                                        <Radio
                                                            // viewType
                                                            // disable
                                                            topLabel={<>服務選擇<Text theme={laptop.modalSrvChooseRequired}>(必填)</Text></>}
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>里程<Text theme={laptop.modalMileageRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                        ...
                                                        <TextInput
                                                            ...
                                                            theme={laptop.modalAmount}
                                                        />

                                                        {/* 新增彈窗 - 施作項目 AddProject */}
                                                        <Textarea
                                                            topLabel={<>施作項目<Text theme={laptop.modalProjectRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            placeholder={""}
