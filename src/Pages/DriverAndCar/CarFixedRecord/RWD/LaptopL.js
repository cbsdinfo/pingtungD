...
import { ReactComponent as Plus } from '../../../../Assets/img/CarFixedRecordPage/Plus.svg'
...
const LaptopLBase = (props) => {
    ...
    const { pages: { carFixedRecord: { rwd: { laptopL } } } } = Theme;
                                            ...
                                            content: (
                                                ...
                                                >
                                                    <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>車輛<Text theme={laptopL.modalCarRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                            ...
                                                            theme={laptopL.modalCar}
                                                        />

                                                        {/* 新增彈窗 - 日期 AddDate */}
                                                        <DateTimePicker
                                                            topLabel={<>日期<Text theme={laptopL.modalDateRequired}>(必填)</Text></>}
                                                        ...
                                                        <Radio
                                                            // viewType
                                                            // disable
                                                            topLabel={<>服務選擇<Text theme={laptopL.modalSrvChooseRequired}>(必填)</Text></>}
                                                        ...
                                                        <TextInput
                                                            // viewType
                                                            topLabel={<>里程<Text theme={laptopL.modalMileageRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            type="text"
                                                            placeholder={""}
                                                        ...
                                                        <TextInput
                                                            ...
                                                            theme={laptopL.modalAmount}
                                                        />

                                                        {/* 新增彈窗 - 施作項目 AddProject */}
                                                        <Textarea
                                                            topLabel={<>施作項目<Text theme={laptopL.modalProjectRequired}>(必填)</Text></>}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            placeholder={""}
