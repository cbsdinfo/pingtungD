...
const LaptopLBase = (props) => {
    ...
    const { pages: { cars: { carsInformation: { rwd: { laptopL } } } } } = Theme;
                    ...
                    >
                        ...
                        >
                            <FormRow>
                                ...
                                <TextInput
                                    viewType
                                    topLabel={<>捐贈＆獎助單位<Text theme={laptopL.donateUnitRequired}>(必填)</Text></>}
                                    baseDefaultTheme={"DefaultTheme"}
                                    type="text"
                                    placeholder={""}
                                ...
                                <TextInput
                                    viewType
                                    topLabel={<>車身高度<Text theme={laptopL.carHeightRequired}>(必填)</Text></>}
                                    baseDefaultTheme={"DefaultTheme"}
                                    type="text"
                                    placeholder={""}
