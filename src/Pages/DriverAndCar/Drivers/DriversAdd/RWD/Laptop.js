...
const LaptopBase = (props) => {
    ...
    const { pages: { drivers: { driversAdd: { rwd: { laptop } } } } } = Theme;
                    ...
                    >
                        ...
                        >
                            ...
                            <FormRow>
                                ...
                                <Selector
                                    bascDefaultTheme={"DefaultTheme"}
                                    topLabel={<>車行<Text theme={laptop.carDealershipRequired}>(必填)</Text></>}
                                    //viewType
                                    isSearchable
                                    placeholder={""}
                                    // isMulti
                        ...
                        <OldList
                            ...
                            columnsAttr={
                                ...
                                [
                                    ...
                                    {
                                        title: <>證照到期日<Text theme={laptop.licenseExpiryDateRequired}>(有該證照則為必填)</Text></>,
                                        width: "522px",
                                            ...
                                            return (
                                                <FormRow>
                                                    <DateTimePicker
                                                        ...
                                                        theme={laptop.licenseExpiryDate}
                                                    />
                                                </FormRow>
                                            )
                                        }
                        ...
                        <OldList
                            ...
                            columnsAttr={
                                ...
                                [
                                    ...
                                    {
                                        title: <>保險到期日<Text theme={laptop.insuranceExpiryDateRequired}>(有該保險則為必填)</Text></>,
                                        width: "522px",
                                        // dataIndex: 'expiryDate',
                                        // sorter: (a, b) => a.expiryDate.length - b.expiryDate.length,
                                        render: (rowData) => {
                                            return (
                                                <FormRow>
                                                    <DateTimePicker
                                                        ...
                                                        theme={laptop.insuranceExpiryDate}
                                                    />
                                                </FormRow>
                                            )
                                        }
