...
const LaptopLBase = (props) => {
    ...
    const { pages: { drivers: { driversInformation: { rwd: { laptopL } } } } } = Theme;
    ...
    return (
        <>
            ...
            >
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptopL.BaseAndNoteContainer}
                >
                                    ...
                                    modalsService.titleModal.normal({
                                        ...
                                        content: (
                                            <>
                                                ...
                                                <ScrollBar
                                                    basedefaulttheme={"DefaultTheme"}
                                                    theme={laptopL.clockInModalContentScrollBar}
                                                >
                                                    {/* 打卡記錄彈窗 ScrollBar 下容器 */}
                                                    <BasicContainer
                                                        baseDefaultTheme={"DefaultTheme"}
                                                        theme={laptopL.clockInModalMainContent}
                                                    >
                                                        <OldList
                                                            checkbox={false}
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptopL.infoCardContainer}
                >
                    <Container>
                        {/* 總趟次資訊卡片 容器 */}
                        <SubContainer
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptopL.licenseContainer}
                >
                    {/* 證照 子標題列 */}
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptopL.insuranceContainer}
                >
