...
import { ReactComponent as Resize } from '../../../../Assets/img/RuralCallCarPage/Resize.svg'
...
import { ReactComponent as StartToEnd } from '../../../../Assets/img/RuralCallCarPage/Arrow.svg'
...
import { BasicButton, CheckboxGroup, NumberInput, Checkbox, CheckboxItem, DateTimePicker, Container, BasicContainer, FormContainer, FormRow, globalContextService, NativeLineButton, OldList, Selector, SubContainer, Text, Textarea, TextInput, Upload, Radio, RadioItem, modalsService, Resizable, OldTable } from '../../../../Components';
...
const TabletBase = (props) => {
    ...
    const { pages: { cases: { ruralCallCar: { rwd: { tablet } } } } } = Theme;
                                ...
                                <OldTable
                                    ...
                                    checkboxOnChecked={
                                        (checkedRowKeys, checkedRows) => {
                                            ...
                                            globalContextService.set("RuralCallCarPage", "CheckedRowKeys", checkedRowKeys);
                                            globalContextService.set("RuralCallCarPage", "CheckedRowsData", checkedRows);
                                        }
                                    }
