...
const LaptopBase = (props) => {
    ...
    const { pages: { cases: { busEdit: { rwd: { laptop } } } } } = Theme;
            ...
            >
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"幸福巴士資料"}
                        theme={laptop.busDataSubTitleBar}
                    />

                    {/* 幸福巴士資料容器 */}
                    <FormContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptop.busDataContainer}
                    >
                        <FormRow>
                            ...
                            <TextInput
                                // viewType
                                topLabel={<>卡號<Text theme={laptop.cardNumberRequired}>(必填)</Text></>}
                                baseDefaultTheme={"DefaultTheme"}
                                type="text"
                                placeholder={""}
