...
const TabletBase = (props) => {
    ...
    const { pages: { cases: { caseInformation: { rwd: { tablet } } } } } = Theme;
            ...
            >
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"長照個案資料"}
                        theme={tablet.longDataSubTitleBar}
                    />

                    {/* 長照個案資料容器 */}
                    <FormContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={tablet.longDataContainer}
                    >
                        <FormRow>
                            ...
                            {globalContextService.get("CaseInformationPage", "Distributable")?.label === '不可派發' &&
                                <Selector
                                    ...
                                    theme={tablet.notDistributableReason}
                                />
                            }
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"違規紀錄"}
                        theme={tablet.recordSubTitleBar}
                    >
                        ...
                        <SubContainer baseDefaultTheme={"DefaultTheme"}>
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.recordUnLockButton}
                                onClick={() => { }}
                            >
                                解除停權
                            </NativeLineButton>
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.recordTodayButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.recordOneMonthButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.recordThreeMonthButton}
                        ...
                        {/*  違規紀錄日期區間 (基本資料 子標題列下方) 容器 */}
                        <SubContainer
                            baseDefaultTheme={"DefaultTheme"}
                            theme={tablet.recordDownContainer}
                        >
                            ...
                            <RangeDateTimePicker
                                ...
                                theme={tablet.recordDateTimeRange}
                            />
                        </SubContainer>
                    ...
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={tablet.recordTableContainer}
                    >
                        <OldTable
                            checkbox={false}
                    ...
                    >
                        ...
                        <SubContainer baseDefaultTheme={"DefaultTheme"}>
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.orderRecordTodayButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.orderRecordWeekButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.orderRecordOneMonthButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={tablet.orderRecordThreeMonthButton}
                        ...
                        <RangeDateTimePicker
                            ...
                            theme={tablet.orderRecordDateTimeRange}
                        />
                    </MainPageSubTitleBar>
