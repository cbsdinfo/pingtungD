...
const LaptopLBase = (props) => {
    ...
    const { pages: { cases: { caseInformation: { rwd: { laptopL } } } } } = Theme;
            ...
            >
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"長照個案資料"}
                        theme={laptopL.longDataSubTitleBar}
                    />

                    {/* 長照個案資料容器 */}
                    <FormContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptopL.longDataContainer}
                    >
                        <FormRow>
                            ...
                            {globalContextService.get("CaseInformationPage", "Distributable")?.label === '不可派發' &&
                                <Selector
                                    ...
                                    theme={laptopL.notDistributableReason}
                                />
                            }
                ...
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"違規紀錄"}
                        theme={laptopL.recordSubTitleBar}
                    >
                        ...
                        <SubContainer baseDefaultTheme={"DefaultTheme"}>
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.recordUnLockButton}
                                onClick={() => { }}
                            >
                                解除停權
                            </NativeLineButton>
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.recordTodayButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.recordWeekButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.recordOneMonthButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.recordThreeMonthButton}
                        ...
                        {/* 違規紀錄 自訂時間 RecordCustomTime  */}
                        <Text
                            theme={laptopL.recordCustomTime}>
                            自訂時間
                        </Text>
                        ...
                        <RangeDateTimePicker
                            ...
                            theme={laptopL.recordDateTimeRange}
                        />
                    ...
                    <BasicContainer
                        bascDefaultTheme={"DefaultTheme"}
                        theme={laptopL.recordTableContainer}
                    >
                        <OldTable
                            checkbox={false}
                    ...
                    >
                        ...
                        <SubContainer baseDefaultTheme={"DefaultTheme"}>
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.orderRecordTodayButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.orderRecordWeekButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.orderRecordOneMonthButton}
                            ...
                            <NativeLineButton
                                ...
                                disable={false}
                                type="button" // 防止提交
                                theme={laptopL.orderRecordThreeMonthButton}
                        ...
                        {/* 個案預約紀錄 自訂時間 OrderRecordDateTimeRange  */}
                        <Text
                            theme={laptopL.orderRecordCustomTime}>
                            自訂時間
                        </Text>
                        ...
                        <RangeDateTimePicker
                            ...
                            theme={laptopL.orderRecordDateTimeRange}
                        />
                    </MainPageSubTitleBar>
