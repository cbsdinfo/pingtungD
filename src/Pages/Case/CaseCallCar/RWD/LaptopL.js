...
import { ReactComponent as StartToEnd } from '../../../../Assets/img/CaseCallCarPage/StartToEnd.svg'
...
import { BasicButton, CheckboxGroup, NumberInput, Checkbox, CheckboxItem, DateTimePicker, BasicContainer, FormContainer, FormRow, globalContextService, NativeLineButton, OldList, NewSelector, Selector, SubContainer, Text, Textarea, TextInput, Upload, Radio, RadioItem, modalsService, Container, OldTable } from '../../../../Components';
...
const LaptopLBase = (props) => {
    ...
    const { pages: { cases: { caseCallCar: { rwd: { laptopL } } } } } = Theme;
                    ...
                    >
                        ...
                        >
                            <FormRow>
                                ...
                                {/*  乘車日期檢核 */}
                                {
                                    ...
                                    <>
                                        ...
                                        <DateTimePicker
                                            ...
                                            onChange={(value, momentObj) => {
                                                if (value !== globalContextService.get("CaseCallCarPage", "TravelTime")) {
                                ...
                                {/* 預約回程檢核 */}
                                {
                                    !isNil(globalContextService.get("CaseCallCarPage", "TravelTime"))
                                    &&
                                    <>
