...
export const CaseCallCar = (props) => {
    ...
    useEffect(() => {
        const historyUnlisten = history.listen((location, action) => {
            ...
            globalContextService.remove("CaseCallCarPage", "firstUseAPIgetClient");
            globalContextService.remove("CaseCallCarPage", "firstUseAPIgetSubOrgs");
        });
