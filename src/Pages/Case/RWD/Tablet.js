...
const TabletBase = (props) => {
    ...
    const { pages: { cases: { rwd: { tablet } } } } = Theme;
                                                ...
                                                content: (
                                                    ...
                                                    >
                                                        <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                            ...
                                                            {/* 新增彈窗 - 出生年月日 Birthday */}
                                                            <DateTimePicker
                                                                topLabel={<>出生年月日<Text theme={tablet.birthdayRequired}>(必填)</Text></>}
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    render: (rowData, allRowData) => {
                                        ...
                                        return (
                                            <>
                                                <Text theme={tablet.nameContainer}>
                                                    {!(moment(allRowData.unLockDate, "YYYY-MM-DD HH:mm:ss").subtract(5, "seconds").isBefore(moment()) || allRowData.unLockDate === null) && <Lock style={tablet.userlocked} />}
                                                    {rowData}
                                                    ...
                                                    >
                                                        {/* 編輯用戶基本資料按鈕 圖標 */}
                                                        <Edit style={tablet.addButtonIcon} />
                                                    </NativeLineButton>
                                                </Text>
                                            </>
                                        )
                                ...
                                },
                                {
                                    ...
                                    render: (rowData, allRowData) => {
                                        ...
                                        return (
                                            <>
                                                <BasicContainer theme={tablet.canUseCaseListTagContainer}>
                                                    {/* 可用身分 Tag */}
                                                    {option.map(item => (
                                                        <Tag
                                                            key={item.value}
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            theme={tablet.canUseCaseListTag}
                                                            text={item.label}
                                                        />
                                                    ))}
                                                    ...
                                                    {(getParseItemLocalStorage("Functions") ?? []).includes("/Case/AddCaseList")
                                                        ...
                                                        <NativeLineButton
                                                            ...
                                                            disable={false}
                                                            type="button" // 防止提交
                                                            theme={tablet.addIdentityButton}
                                                            onClick={(e) => {
                                                                e.preventDefault();
