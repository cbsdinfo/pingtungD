...
import { ReactComponent as Resize } from '../../../../Assets/img/WhiteCallCarPage/Resize.svg'
...
import { ReactComponent as StartToEnd } from '../../../../Assets/img/WhiteCallCarPage/Arrow.svg'
...
import { BasicButton, CheckboxGroup, NumberInput, Checkbox, CheckboxItem, DateTimePicker, BasicContainer, FormContainer, FormRow, globalContextService, NativeLineButton, OldList, Selector, SubContainer, Text, Textarea, TextInput, Upload, Radio, RadioItem, modalsService, Container, Resizable, OldTable } from '../../../../Components';
...
const TabletBase = (props) => {
    ...
    const { pages: { cases: { whiteCallCar: { rwd: { tablet } } } } } = Theme;
