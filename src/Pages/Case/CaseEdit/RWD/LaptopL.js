...
const LaptopLBase = (props) => {
    ...
    const { pages: { cases: { caseEdit: { rwd: { laptopL } } } } } = Theme;
                ...
                >
                    ...
                    >
                        <FormRow>
                            ...
                            <Selector
                                bascDefaultTheme={"DefaultTheme"}
                                topLabel={<>管理單位<Text theme={laptopL.managementUnitRequired}>(必填)</Text></>}
                            ...
                            <Selector
                                ...
                                topLabel={
                                    <>
                                        社會福利身份
                                            <Text theme={laptopL.boonTypeRequired}>(必填)</Text>
                                        <NativeLineButton
                                            baseDefaultTheme={"DefaultTheme"}
                                            disable={false}
                                            type="button" // 防止提交
                                            theme={laptopL.boonTypeEditButton}
                                            onClick={() => {
                            ...
                            <Selector
                                bascDefaultTheme={"DefaultTheme"}
                                topLabel={<>失能等級<Text theme={laptopL.disabilityLevelRequired}>(必填)</Text></>}
                                //viewType
                                isSearchable
                                placeholder={""}
                                // isMulti
                            ...
                            <DateTimePicker
                                topLabel={<>額度控管留用首月<Text theme={laptopL.quotaKeepYMRequired}>(必填)</Text></>}
                                // type={"time"} time、date、week、month、quarter、year
                                type={"month"}
                                format={"YYYY-MM"}
                                bascDefaultTheme={"DefaultTheme"}
                            ...
                            <Selector
                                bascDefaultTheme={"DefaultTheme"}
                                topLabel={<>可否派發<Text theme={laptopL.distributableRequired}>(必填)</Text></>}
                                //viewType
                                isSearchable
                                placeholder={""}
                                // isMulti
                            ...
                            {globalContextService.get("CaseEditPage", "Distributable")?.label === '不可派發' &&
                                <Selector
                                    topLabel={<>不可派發原因<Text theme={laptopL.notDistributableReasonRequired}>(必填)</Text></>}
                                    baseDefaultTheme={"DefaultTheme"}
                                    isSearchable
                                    placeholder={""}
                                    value={
                                            ...
                                            modalsService.titleModal.normal({
                                                ...
                                                content: (
                                                    <FormContainer
                                                        ...
                                                        theme={laptopL.selectloseTypeFormContainer}
                                                    >
                                                        <FormRow baseDefaultTheme={"DefaultTheme"}>
                                                            ...
                                                            <Selector
                                                                ...
                                                                menuPosition={true}
                                                                theme={laptopL.selectloseType}
                                                            />
                                                        </FormRow>
                                                    </FormContainer>
                                                ),
                                                theme: laptopL.selectloseTypeModal
                                            })
                                            //#endregion
                                        }
