...
const LaptopBase = (props) => {
    ...
    const { pages: { whiteConsole: { rwd: { laptop } } } } = Theme;
    ...
    return (
        <>
            ...
            >
                ...
                <BasicContainer
                    baseDefaultTheme={"DefaultTheme"}
                    theme={laptop.newOrderContainer}
                >
                    ...
                    <MainPageSubTitleBar
                        bascDefaultTheme={"DefaultTheme"}
                        titleText={"新訂單"}
                        theme={laptop.newOrderSubTitleBar}
                    >

                    </MainPageSubTitleBar>

                    {/* 訂單容器 */}
                    <Container theme={laptop.orderContainer} >
                                    ...
                                    <CarOrder
                                        ...
                                        title={
                                            <>
                                                {/* 訂單姓名 */}
                                                <Text
                                                    theme={laptop.carOrderCarType}
                                                >
                                                    <OrderCarType style={laptop.carOrderCarTypeSvg} />
                                        ...
                                        theme={laptop.carOrder}
                                    >
                                        {/* 內容部分容器 */}
                                        <BasicContainer
                                            theme={laptop.carOrderContent}
                                        >
                                            {/* 姓名、可否共乘、搭乘人數容器 */}
                                            <BasicContainer
                                                theme={laptop.carOrderNameSContainer}
                                            >

                                                {/* 訂單姓名 */}
                                                <Text
                                                    theme={laptop.carOrderName}
                                                >
                                                    {item.userName}
                                                </Text>
                                                ...
                                                {/* 訂單搭乘人數 */}
                                                <Text
                                                    theme={laptop.carOrderManCount}
                                                >
                                                    <TakeNum style={laptop.carOrderManCountSvg} />
                                            ...
                                            {/* 搭乘起點 */}
                                            <Text
                                                theme={laptop.carOrderStartPos}
                                            >
                                                <OrderStart style={laptop.carOrderStartPosSvg} />
                                                {item.fromAddr}
                                            </Text>

                                            {/* 搭乘冒號 */}
                                            <Text
                                                theme={laptop.carOrderTo}
                                            >
                                                :
                                            </Text>
                                            ...
                                            {/* 搭乘終點 */}
                                            <Text
                                                theme={laptop.carOrderEndPos}
                                            >
                                                <OrderEnd style={laptop.carOrderEndPosSvg} />
                                                {item.toAddr}
                                            </Text>
                                                ...
                                                <React.Fragment key={rowData?.id ?? allRowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {allRowData?.isShare
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 姓名 第一列 */}
                                                                                <Text theme={laptop.dispatchUserNameOne} >
                                                                                    {it?.userName}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 姓名 接續列 */}
                                                                                <Text theme={laptop.dispatchUserNameTwo} >
                                                                                    {it?.userName}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                            ...
                                                            <>
                                                                {/* 調度台 姓名 單獨 */}
                                                                <Text theme={laptop.dispatchUserNameOnly} >
                                                                    {rowData}
                                                                </Text>
                                                            </>
                                                        }
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 訂單狀態 第一列 */}
                                                                                <Text theme={laptop.dispatchStatusOne} >
                                                                                    <Tag
                                                                                        baseDefaultTheme={"DefaultTheme"}
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 訂單狀態 接續列 */}
                                                                                <Text theme={laptop.dispatchStatusTwo} >
                                                                                    <Tag
                                                                                        baseDefaultTheme={"DefaultTheme"}
                                                                                        theme={statusMapping(it?.status, true)}
                                                                                        text={statusMapping(it?.status)}
                                                ...
                                                <React.Fragment key={rowData?.id ?? allRowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {allRowData?.isShare
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 乘車預約時間 第一列 */}
                                                                                <Text theme={laptop.dispatchReserveDateOne} >
                                                                                    {it?.reserveDate}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 乘車預約時間 接續列 */}
                                                                                <Text theme={laptop.dispatchReserveDateTwo} >
                                                                                    {it?.reserveDate}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                            ...
                                                            <>
                                                                {/* 調度台 乘車預約時間 單獨 */}
                                                                <Text theme={laptop.dispatchReserveDateOnly} >
                                                                    {rowData}
                                                                </Text>
                                                            </>
                                                        }
                                                ...
                                                <React.Fragment key={rowData?.id ?? rowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {rowData?.isShare
                                                                    ...
                                                                    if (ind === 0) {
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 起迄點 接續列 */}
                                                                                <Text
                                                                                    theme={laptop.dispatchFromAndToAddrTwo}
                                                                                >
                                                                                    {/* 調度台 起點文字 */}
                                                                                    <Text theme={laptop.dispatchFromAddr}>
                                                            ...
                                                            <>
                                                                {/* 調度台 起迄點 單獨 */}
                                                                <Text theme={laptop.dispatchFromAndToAddrOnly} >
                                                ...
                                                <React.Fragment key={rowData?.id ?? allRowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {allRowData?.isShare
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 可否共乘 第一列 */}
                                                                                <Text theme={laptop.dispatchCanSharedOne} >
                                                                                    {it?.canShared ? "是" : "否"}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 可否共乘 接續列 */}
                                                                                <Text theme={laptop.dispatchCanSharedTwo} >
                                                                                    {it?.canShared ? "是" : "否"}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                            ...
                                                            <>
                                                                {/* 調度台 可否共乘 單獨 */}
                                                                <Text theme={laptop.dispatchCanSharedOnly} >
                                                                    {rowData ? "是" : "否"}
                                                                </Text>
                                                            </>
                                                        }
                                                ...
                                                <React.Fragment key={rowData?.id ?? allRowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {allRowData?.isShare
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 車輛類型 第一列 */}
                                                                                <Text theme={laptop.dispatchCarCategoryNameOne} >
                                                                                    {it?.carCategoryName}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 車輛類型 接續列 */}
                                                                                <Text theme={laptop.dispatchCarCategoryNameTwo} >
                                                                                    {it?.carCategoryName}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                            ...
                                                            <>
                                                                {/* 調度台 車輛類型 單獨 */}
                                                                <Text theme={laptop.dispatchCarCategoryNameOnly} >
                                                                    {rowData}
                                                                </Text>
                                                            </>
                                                        }
                                                ...
                                                <React.Fragment key={rowData?.id ?? allRowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {allRowData?.isShare
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 搭乘人數 第一列 */}
                                                                                <Text theme={laptop.dispatchPassengerNumOne} >
                                                                                    {it?.passengerNum}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 搭乘人數 接續列 */}
                                                                                <Text theme={laptop.dispatchPassengerNumTwo} >
                                                                                    {it?.passengerNum}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                            ...
                                                            <>
                                                                {/* 調度台 搭乘人數 單獨 */}
                                                                <Text theme={laptop.dispatchPassengerNumOnly} >
                                                                    {rowData}
                                                                </Text>
                                                            </>
                                                        }
                                                ...
                                                <React.Fragment key={rowData?.id ?? allRowData?.isShare?.[0]?.id}>
                                                    <BasicContainer>
                                                        {allRowData?.isShare
                                                                ...
                                                                {allRowData.isShare.map((it, ind) => {
                                                                    if (ind === 0) {
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 所屬單位 第一列 */}
                                                                                <Text theme={laptop.dispatchOrgNameOne} >
                                                                                    {it?.orgName}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                {/* 調度台 所屬單位 接續列 */}
                                                                                <Text theme={laptop.dispatchOrgNameTwo} >
                                                                                    {it?.orgName}
                                                                                </Text>
                                                                            </>
                                                                        )
                                                            ...
                                                            <>
                                                                {/* 調度台 所屬單位 單獨 */}
                                                                <Text theme={laptop.dispatchOrgNameOnly} >
                                                                    {rowData}
                                                                </Text>
                                                            </>
                                                        }
