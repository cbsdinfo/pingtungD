export default {
    ...
    //#endregion
    //#region 生日 Birthday 上標題 (必填)文字樣式
    birthdayRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
    ...
    //#endregion
    //#region 管理單位 ManagementUnit 上標題 (必填)文字樣式
    managementUnitRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
            color: "#ff4d4f",
    ...
    //#endregion
    //#region 社會福利身份 BoonType 上標題 (必填)文字樣式
    boonTypeRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
    ...
    //#endregion
    //#region 失能等級 DisabilityLevel 上標題 (必填)文字樣式
    disabilityLevelRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
            color: "#ff4d4f",
    ...
    //#endregion
    //#region 額度控管留用首月 QuotaKeepYM 上標題 (必填)文字樣式
    quotaKeepYMRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
    ...
    //#endregion
    //#region 可否派發 Distributable 上標題 (必填)文字樣式
    distributableRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
            color: "#ff4d4f",
    ...
    //#endregion
    //#region 不可派發原因 NotDistributableReason 上標題 (必填)文字樣式
    notDistributableReasonRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
            color: "#ff4d4f",
    ...
    //#region 請選擇失效方式 Modal
    //#region editFormContainer
    selectloseTypeFormContainer: {
    ...
    //#region 輪住地址新增區塊(區域) TurnDistrictAdd
    turnDistrictAdd: {
        container: {
            basic: (style, props) => ({
                ...style,
