export default {
    ...
    //#endregion
    //#region 標題列第二列 SecondFormContainer
    secondFormContainer: {
        container: {
            basic: (style, props) => ({
                ...style,
    ...
    //#region 選擇機構 SelectOrg
    selectOrg: {
        container: {
            basic: (style, props) => ({
                ...style,
                maxWidth: "calc((100vw - 235px) * 0.63)",
                flexBasis: "calc((100vw - 235px) * 0.63)"
                // padding: "0 0 0 12px",
                // display: "inline-block",
                // ...style.occupy(6)
            })
    ...
    leftMenuContainer: {
        basic: (style, props) => ({
            ...
            maxWidth: "19.5%",
            flexBasis: "19.5%",
            height: "calc( 100vh - 219px - 4px - 16px - 32px)",
            padding: "0 16px 0 0"
        })
    },
    //#endregion
    ...
    //#region OrgsTree 在此遍歷選單(機構)內容 樣式
    // ...
    //#endregion
    ...
    //#region 編輯彈窗 - 服務單位 Organizations
    organizations: {
        container: {
            basic: (style, props) => ({
                ...style,
    ...
    //#endregion
    //#region 編輯彈窗 - 服務單位 Organizations 上標題 (必填)文字樣式
    ...
    //#endregion
    //#region 編輯彈窗 - 帳號 Account 上標題 (必填)文字樣式
    accountRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
    ...
    //#endregion
    //#region 編輯彈窗 - 手機號碼 Cellphone 上標題 (必填)文字樣式
    cellphoneRequired: {
        basic: (style, props) => ({
            ...style,
            display: "inline-block",
