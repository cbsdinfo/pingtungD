...
import { SubContainer, BasicContainer, Text, ScrollBar } from '../../Components';
...
&& td.ant-table-cell.ant-table-selection-column.ant-table-cell-fix-left {
...
//#region 表單內的勾選框
export const DispatchTableBase = (props) => {
...
export const DispatchTable = styled(DispatchTableBase).attrs((props) => ({}))`
