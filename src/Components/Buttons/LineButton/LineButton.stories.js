...
//#endregion
//#region 引入說明檔案
import LineButtonNote from './LineButtonNote.md'
//#endregion
//#region 引入匯出樣式處理函數
...
//#region LineButton 組件
export const LineButton_ = (props) => {
    ...
    const switchDefaultTheme = (themeName) => {
        switch (themeName) {
            case "SecondaryTheme":
                ...
                SecondaryThemecontainerbasicborder = text("SecondaryTheme_container_basic_border", SecondaryTheme.container.basic.border)
            ...
            case "PrimaryTheme":
                ...
                PrimaryThemecontainerbasicborder = text("PrimaryTheme_container_basic_border", PrimaryTheme.container.basic.border)
            ...
            default:
                ...
                DefaultThemecontainerbasicborder = text("DefaultTheme_container_basic_border", DefaultTheme.container.basic.border)
...
LineButton_.story = {
    parameters: {
        notes: { "LineButtonNote": LineButtonNote },
    }
};
            //#endregion
