...
//#region 基礎按鈕
export const LeftSideDrawerBase = (props) => {
    ...
    return (
        <>
            <Container
                ...
                //theme={switchDefaultTheme(props.baseDefaultTheme)["container"]} //吃props
            ...
            <BasicContainer
                ...
                collapse={props.collapse} // 轉發 props
                //theme={switchDefaultTheme(props.baseDefaultTheme)["content"]} //吃props
...
export const LeftSideDrawer = styled(LeftSideDrawerBase).attrs((props) => ({}))`
