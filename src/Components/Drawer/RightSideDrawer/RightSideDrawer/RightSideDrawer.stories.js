...
//#endregion
//#region 引入說明檔案
import RightSideDrawerNote from './RightSideDrawerNote.md'
//#endregion
//#region 引入匯出樣式處理函數
...
//#region RightSideDrawer 組件
export const RightSideDrawer_ = (props) => {
                      ...
                      theme={{                        
                        container:{
                            basic: (style, props) => ({
                              ...
                              right: \`\${props.collapse ? "-100%" : "0rem"}\`, //若有調整寬度請連帶調整
                        ...
                        content:{
                            basic: (style, props) => ({
                              ...
                              right: \`\${props.collapse ? "-60%" : "0rem"}\`, //若有調整寬度請連帶調整
    ...
    return (
        <>
            ...
            {/* <button style={{ position: "fixed", zIndex: 300 }} onClick={() => { Propscollapse = !Propscollapse; setS(s => !s) }}> 展開/收合 </button> */}
        </>
    );
};

RightSideDrawer_.story = {
    parameters: {
        notes: { "RightSideDrawerNote": RightSideDrawerNote },
    }
};
            //#endregion
