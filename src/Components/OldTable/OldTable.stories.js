...
//#endregion
//#region 引入說明檔案
import OldTableNote from './OldTableNote.md'
//#endregion
//#region 引入匯出樣式處理函數
...
export const OldTable_ = (props) => {

    return "OldTable 尚未提供實時展示功能，請直接閱讀 Note";
};

OldTable_.story = {
    parameters: {
        notes: { "OldTable": OldTableNote },
    }
};
//#endregion
