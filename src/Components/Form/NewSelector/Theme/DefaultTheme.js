export default {
    ...
    //#endregion
    //#region 勾選框本體
    viewTypeDateTimePickerContainer: {
        basic: (style, props) => ({
            //#region 基本設置
            boxSizing: "border-box",
            position: "relative",       //控制position屬性: static、relative、fixed、absolute、sticky、inherit、initial
    ...
    //#endregion
    //#region dateTimePickerSubContainer 下拉框 次容器
    selectorSubContainer: {
        basic: (style, props) => ({
            width: "100%",
            height: "28px",
            // height: "32px", // 適應react select設置
            color: "inherit",
    ...
    //#endregion
    //#region dateTimePickerInput 下拉框 的 Input
    selectorPickerInput: {
        basic: (style, props) => ({
            color: "rgba(0, 0, 0, 0.65)",
            cursor: "default"
