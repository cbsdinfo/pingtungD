export default {
    ...
    viewTypeTextarea: {
        basic: (style, props) => ({
            ...
            //#endregion
            //#region 覆寫樣式
            minHeight: props?.textareaLineHeight ? `${props.textareaLineHeight}px` : "32px",
            width: "100%",
            fontSize: "14px",
            color: " rgba(0, 0, 0, 0.85)",
            lineHeight: "32px",
    ...
    viewTypeTextareaBottom: {
        basic: (style, props) => ({
            ...
            width: "100%",
            position: "absolute",
            top: `${(props.index + 1) * props.textareaLineHeight - 3}px`,
