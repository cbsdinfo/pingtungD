...
//#endregion
//#region 引入說明檔案
import TreeSelectorNote from './TreeSelectorNote.md'
//#endregion
//#region 引入匯出樣式處理函數
...
export const TreeSelector_ = (props) => {

    return "Selector 尚未提供實時展示功能，請直接閱讀 Note";
};

TreeSelector_.story = {
    parameters: {
        notes: { "TreeSelectorNote": TreeSelectorNote },
    }
};
//#endregion
