...
//#endregion
//#region 引入說明檔案
import NumberInputNote from './NumberInputNote.md'
//#endregion
//#region 引入匯出樣式處理函數
...
export const NumberInput_ = (props) => {

    return "NumberInput 尚未提供實時展示功能，請直接閱讀 Note";
};

NumberInput_.story = {
    parameters: {
        notes: { "NumberInput": NumberInputNote },
    }
};
//#endregion
