...
&& .ant-table-thead { 
    // line:71 與 table 不同 ant-table-header，應是因少了scroll參數
...
&& .ant-table-tbody {
    // line:105 與 table 不同 ant-table-header，應是因少了scroll參數
...
//#region 表單內的勾選框
export const OldListBase = (props) => {
                    ...
                    locale={{
                        emptyText: props?.noDataMessage ?
                            ...
                            (
                                ...
                                >
                                    查無資料
                                    {!props.hidePageFoot && <div className={"ant-pagination"} style={{ height: "32px", margin: "16px" }} />}
                                </Text>
                            ),
...
export const OldList = styled(OldListBase).attrs((props) => ({}))`
