...
//#endregion
//#region 引入說明檔案
import OldListNote from './OldListNote.md'
//#endregion
//#region 引入匯出樣式處理函數
...
export const OldList_ = (props) => {

    return "OldList 尚未提供實時展示功能，請直接閱讀 Note";
};

OldList_.story = {
    parameters: {
        notes: { "OldList": OldListNote },
    }
};
//#endregion
